    ...
    <main className="overflow-x-hidden">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
              ...
              <FadeIn key={cat.title} delay={i * 0.08}>
                <div className="bg-slate-50 rounded-2xl p-8 border border-slate-100 h-full">
                  <div className="flex items-center gap-3 mb-5">
                    <div className="w-2 h-8 rounded-full bg-light-blue" />
                    <h3 className="text-xl font-semibold text-dark-blue">{cat.title}</h3>
                  </div>
                  <ul className="flex flex-col gap-2.5">
                    {cat.items.map((item) => (
                      <li key={item} className="flex items-start gap-3 text-slate-600 font-light text-sm">
                        <svg className="w-4 h-4 text-light-blue shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <FadeIn className="mt-12 bg-dark-blue rounded-2xl p-8 text-center">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-7 py-3 bg-light-blue text-white font-semibold rounded-full hover:bg-blue-500 transition-colors cursor-pointer"
            >
