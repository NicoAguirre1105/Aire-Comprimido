...
export default function ContactUs() {
  const buttonStyle = "text-center w-fit text-xl max-sm:text-lg py-3 px-7 rounded-[2rem] font-bold hover:cursor-pointer transition-all duration-300 bg-light-blue text-white hover:bg-dark-blue hover:text-white"

  const {isVisible, toggleContact } = useContactVisibility()
  
  return (
    <div className="bg-grey-blue flex flex-col py-[6.25rem] px-[10rem] max-md:px-20 max-md:py-20 items-center gap-10">
