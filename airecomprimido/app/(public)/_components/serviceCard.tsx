...
export default function ServiceCard({
    ...
    const buttonStyle = "text-center py-2 px-5 rounded-[2rem] font-bold hover:cursor-pointer transition-all duration-300 bg-grey-blue text-dark-blue hover:bg-dark-blue hover:text-white"
