...
export default function Mantenimiento() {
  return (
    <main className="overflow-x-hidden">
      ...
      {/* Hero */}
      <section className="bg-dark-blue py-20 px-6 relative overflow-hidden">
        <div
      ...
      <section className="py-20 px-6 bg-slate-50">
        <div className="max-w-6xl mx-auto">
              ...
              <FadeIn key={s.title} delay={i * 0.1}>
                <div className="group flex flex-col bg-white rounded-2xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 h-full">
                  ...
                  <div className="p-6 flex-1">
                    <h3 className="text-lg font-semibold text-dark-blue mb-2">{s.title}</h3>
          ...
          {/* Specialties */}
          <FadeIn>
            <div className="bg-dark-blue rounded-2xl p-8 md:p-10">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
                {specialties.map((s) => (
                  <div key={s.title} className="flex flex-col items-center gap-3 bg-slate-800 rounded-xl p-4 text-center">
                    <div className="w-11 h-11 rounded-xl bg-dark-blue border border-slate-600 text-light-blue flex items-center justify-center">
                      {s.icon}
                    </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <FadeIn direction="left">
            <div className="relative rounded-2xl overflow-hidden aspect-4/3">
              <Image
                src="/img/aire_tubo.webp"
                alt="Instalación de redes de aire"
                fill
                className="object-cover"
              />
              <div className="absolute inset-0 bg-linear-to-t from-dark-blue/50 to-transparent" />
            </div>
          </FadeIn>
          <FadeIn direction="right">
            ...
            <h2 className="text-4xl font-bold text-dark-blue mb-5">
      ...
      <section className="py-16 px-6 bg-slate-50">
        <FadeIn className="max-w-3xl mx-auto text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-3.5 bg-light-blue text-white font-semibold rounded-full hover:bg-blue-500 transition-colors cursor-pointer"
          >
